/**
 * Functionality specific to fixter.
 *
...
/*------------------------------------------------------------------------------*/ 
	 ( function() {
		...
		jQuery( '.menu-toggle' ).on( 'click.fixter', function() {
...
/*------------------------------------------------------------------------------*/ 
	...
	jQuery('#site-header-menu #site-navigation div.nav-menu > ul > li:has(ul), .prt-mmmenu-override-yes #site-header-menu #site-navigation .mega-menu-wrap > ul > li:has(ul)').append("<span class='righticon'><i class='prt-fixter-icon-angle-down'></i></span>");	
...
/*------------------------------------------------------------------------------*/
	jQuery('.righticon').on('click', function() {
		if(jQuery(this).siblings('.sub-menu, .children, .mega-sub-menu').hasClass('open')){
			...
			jQuery( 'i', jQuery(this) ).removeClass('prt-fixter-icon-angle-up').addClass('prt-fixter-icon-angle-down');
		} else {
			jQuery(this).siblings('.sub-menu, .children, .mega-sub-menu').addClass('open');			
			jQuery( 'i', jQuery(this) ).removeClass('prt-fixter-icon-angle-down').addClass('prt-fixter-icon-angle-up');
		}
		return false;
 	});
...
// Top btn click event
	...
	jQuery( ".prt-header-search-link a" ).on('click', function(){
		...
		if (jQuery('.prt-header-search-link a').hasClass('sclose')) {	
			jQuery( ".prt-header-search-link a i" ).removeClass('prt-fixter-icon-search').addClass('prt-fixter-icon-close');
			jQuery(this).removeClass('sclose').addClass('open');	
			jQuery(".prt-search-overlay").addClass('st-show');					
		} else {
			jQuery(this).removeClass('open').addClass('sclose');
			jQuery( ".prt-header-search-link a i" ).removeClass('prt-fixter-icon-close').addClass('prt-fixter-icon-search');	
			jQuery(".prt-search-overlay").removeClass('st-show');	
		}	
	});	
...
var preyantechnosys_showcasebox = function() {
	...
	jQuery('.prt_showcasebox_wrapper').each(function(){
		var parentDiv = jQuery(this);
				...
				jQuery('.prt_showcasebox_wrapper .prt_showcasebox_contents').hover(function(){
		 			jQuery('.prt_showcasebox_wrapper .prt_showcasebox_contents').removeClass("active");
					jQuery(this).addClass("active");
		 		});
...
jQuery(window).resize(function() {
 ...
 jQuery(document).ready(function() {
	...
	jQuery('.preyantechnosys-element-servicebox-styleone .preyantechnosys-boxes-row-wrapper .prt-box-col-wrapper:first').addClass("active");
	jQuery('.preyantechnosys-element-servicebox-styleone .preyantechnosys-boxes-row-wrapper .prt-box-col-wrapper').hover(function(){
 	jQuery('.preyantechnosys-element-servicebox-styleone .preyantechnosys-boxes-row-wrapper .prt-box-col-wrapper').removeClass("active");
	jQuery(this).addClass("active");
 });
...
function tm_reel_video() {
		if (!jQuery(".tm-element-reel-video-style-1")[0]) {
			return
		} 
		...
		function removeProps(){  
		  jQuery(".video-content").css("width", "0");
		}
		let tl = gsap.timeline({
		  scrollTrigger: {
			trigger: document.querySelector('.tm-element-reel-video-style-1'),
			start: "top 50%",
			pin: false,
			end: () => '+=' + 1000,
			scrub: 1
